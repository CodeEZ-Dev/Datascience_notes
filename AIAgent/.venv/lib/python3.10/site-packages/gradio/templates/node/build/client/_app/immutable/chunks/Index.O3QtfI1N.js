const __vite__fileDeps=["./index.B4s-1Iyb.js","./index.pw4Rx2AD.js","./index.pCQ89GWZ.js","./index.BrFXipic.js","./index.CqLyan7n.js","./index.dLfUk_d0.js","./frontmatter.DLbE8ueO.js","./yaml.BMKOA8H-.js","./index.w8GfS9TJ.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
import { I as IconButton, t as Check, v as Copy$1, B as Block, S as Static } from "./2.DGiuLZW-.js";
...
const lang_map = {
  python: () => __vitePreload(() => import("./index.B4s-1Iyb.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url).then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      __vitePreload(() => import("./index.pCQ89GWZ.js"), true ? __vite__mapDeps([2,3,1,4,5]) : void 0, import.meta.url),
      __vitePreload(() => import("./frontmatter.DLbE8ueO.js"), true ? __vite__mapDeps([6,7]) : void 0, import.meta.url)
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => __vitePreload(() => import("./index.w8GfS9TJ.js"), true ? __vite__mapDeps([8,1]) : void 0, import.meta.url).then((m) => m.json()),
  html: () => __vitePreload(() => import("./index.BrFXipic.js"), true ? __vite__mapDeps([3,1,4,5]) : void 0, import.meta.url).then((m) => m.html()),
  css: () => __vitePreload(() => import("./index.CqLyan7n.js"), true ? __vite__mapDeps([4,1]) : void 0, import.meta.url).then((m) => m.css()),
  javascript: () => __vitePreload(() => import("./index.dLfUk_d0.js"), true ? __vite__mapDeps([5,1]) : void 0, import.meta.url).then((m) => m.javascript()),
  jinja2: () => __vitePreload(() => import("./jinja2.2Vo2sGef.js"), true ? [] : void 0, import.meta.url).then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => __vitePreload(() => import("./index.dLfUk_d0.js"), true ? __vite__mapDeps([5,1]) : void 0, import.meta.url).then(
