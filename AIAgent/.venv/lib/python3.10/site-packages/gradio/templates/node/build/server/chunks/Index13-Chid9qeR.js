...
import { B as Block, S as Static, e as BlockLabel, W as Code$2, g as Empty, i as IconButton, K as Copy$1, D as Download$1, h as IconButtonWrapper } from './2-DD3BUgTt.js';
...
const lang_map = {
  python: () => import('./index27-stU4lno5.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index28-CTT1htdu.js'),
      import('./frontmatter-C6L1hh5g.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index32-BUxpFI4m.js').then((m) => m.json()),
  html: () => import('./index29-DUnhxbIr.js').then((m) => m.html()),
  css: () => import('./index30-DEmJaULe.js').then((m) => m.css()),
  javascript: () => import('./index31-C5nc27Mu.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index31-C5nc27Mu.js').then(
...
//# sourceMappingURL=Index13-Chid9qeR.js.map
